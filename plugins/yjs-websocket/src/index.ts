...
import * as syncProtocol from '@aomao/plugin-yjs-protocols/src/sync';
import * as authProtocol from '@aomao/plugin-yjs-protocols/src/auth';
import * as awarenessProtocol from '@aomao/plugin-yjs-protocols/src/awareness';
